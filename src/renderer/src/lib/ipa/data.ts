...
export const LATIN_EXTRA: { zh: string; en: string; items: string[] }[] = [
  ...
  { zh: '抑音', en: 'Grave', items: ['à', 'è', 'ì', 'ò', 'ù', 'ǹ', 'À', 'È', 'Ì', 'Ò', 'Ù'] },
  {
    zh: '扬抑',
    en: 'Circumflex',
    items: ['â', 'ê', 'î', 'ô', 'û', 'ŷ', 'ĉ', 'ĝ', 'ĥ', 'ĵ', 'ŝ', 'ŵ', 'Â', 'Ê', 'Î', 'Ô', 'Û']
  },
  {
    zh: '抑扬',
    en: 'Caron',
  ...
  },
  {
    zh: '尾钩 / 软音',
    en: 'Ogonek & cedilla',
    items: ['ą', 'ę', 'į', 'ǫ', 'ų', 'ç', 'ş', 'ţ', 'ģ', 'ķ', 'ļ', 'ņ', 'ŗ', 'Ç', 'Ş']
  },
  {
    zh: '其他字母',
    en: 'Other letters',
  ...
  {
    zh: '双锐 / 双抑',
    en: 'Double acute & grave',
    items: ['ő', 'ű', 'ȁ', 'ȅ', 'ȉ', 'ȍ', 'ȕ', 'Ő', 'Ű']
  },
  {
    zh: '上环 / 横杠',
    en: 'Ring & stroke',
    items: ['å', 'ů', 'ẘ', 'ẙ', 'ƀ', 'đ', 'ǥ', 'ħ', 'ɨ', 'ł', 'ø', 'ŧ', 'ʉ', 'ƶ']
  }
]
...
export function allSymbols(): Sym[] {
  ...
  for (const g of LATIN_EXTRA)
    for (const s of g.items) out.push({ s, zh: `${g.zh} ${s}`, en: `${g.en} ${s}` })
  return out
}
