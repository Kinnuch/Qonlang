export default {
  ...
  welcome: {
    ...
    exampleDesc: {
      aelith:
        '黏着先验语：祖语→现代语的语系与姊妹语（关系图里对比同源词的音变与意思）、满足 / 不满足环境两路的音变规则、特征与重音规则、音节边界 σ、自定义重音、元音和谐、流水线构形的九种步骤（含构形套构形）、变体与继承、一个词类几个构形、一个词条几个构形、按阴阳换字母、连读浊化反推、复合词类、检视器模块、词源链、从构形生成的词条、已 gloss 的语料、卢恩刻文与手写字形。',
      tsahun:
