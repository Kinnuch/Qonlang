...
const en: Dict = {
  ...
  welcome: {
    ...
    uiLang: 'Language',
    personalize: 'Theme',
    skinMore: 'Fonts, entry cards and background images live on the Theme page inside a project.',
  ...
  tour: {
    ...
    steps: {
      ...
      script: [
        ...
        'Click a glyph to edit its character and value; after importing a font file, assign it to this script in the Theme module so the boxes turn into glyphs.',
      ...
      skin: [
        'The Theme module comes with several presets — click one to try a different set of interface colours and fonts.',
        'A theme you have set up can be exported to a file and shared, and someone else’s theme imported here; an import is previewed before it is applied.',
  ...
  corpus: {
    ...
    rewriteText: 'Also rewrite the word in the text',
    rewriteTextTitle:
      'Replace this one occurrence in the text with the chosen entry’s spelling; the same word elsewhere stays as it is',
  ...
  skin: {
    ...
    title: 'Theme',
    hint: 'Theme settings are stored on this computer, not in the project file.',
    presets: 'Presets',
  ...
  bench: {
    ...
    hint: 'Write the translation first: the app looks up words in the lexicon that it may need and floats them below as bubbles. Drag the ones you want into the row above (or click to add them at the end); click a word in the row to pick its form and add affixes, particles and other pieces, and the original text builds itself.',
    ...
    chipHint: 'Click to edit this word: pick its form, add affixes or particles',
    deckHint:
    ...
    becomes: 'With it: {form}',
    removePiece: 'Remove this piece',
    stripHint: 'Drag to change the order of the pieces',
    morphemeHint:
    ...
    cat: {
      ...
      person: 'Person',
      gender: 'Gender',
      definiteness: 'Definiteness & deixis',
      possession: 'Possession',
      derivation: 'Derivation',
      information: 'Topic & focus',
