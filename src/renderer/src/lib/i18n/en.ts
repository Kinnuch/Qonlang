...
const en: Dict = {
  ...
  lexicon: {
    ...
    etyTypes: {
      ...
      inherited: 'Inherited (sound change)',
      unknown: 'unknown'
    },
    sources: 'Sources',
  ...
  images: {
    ...
    crop: 'Crop',
    zoom: 'Zoom',
    cropHint: 'This image is {iw}×{ih}, which does not match the project image size {w}×{h}: drag the bright frame over the area to keep (wheel or slider to zoom), or change the default size under Settings → Entry image size first.',
    sizeHint: 'Uniform size {w}×{h}; matching images are stored as-is, same-ratio images are scaled, others open the cropper. PNG / GIF stay lossless; JPEG / WebP keep their format at high quality.'
  },
  skin: {
    title: 'Skin',
